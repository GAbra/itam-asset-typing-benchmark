...
docker compose run --rm demo java -jar target/itam-asset-typing-benchmark-1.0.0.jar verify --data $data --out "results/local/verify-$Count.json"
...
docker compose run --rm demo java -jar target/itam-asset-typing-benchmark-1.0.0.jar benchmark --data $data --warmup 2 --runs 5 --batch $batchSize --out "results/local/benchmark-$Count.json"
