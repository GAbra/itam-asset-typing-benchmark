...
docker compose run --rm demo java -jar target/itam-asset-typing-benchmark-1.0.0.jar generate --count $Count --seed 20260909 --out "data/generated/normalized-$Count.jsonl"
